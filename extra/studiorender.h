...
public:
	...
	virtual IMaterial* get_material_page() = 0;
	...
	virtual void color_modulate(Color col) = 0;

	virtual void set_material_var_flag(int flag, bool on) = 0;
	virtual bool get_material_var_flag(int flag) const = 0;
	...
	void set_material_var_flag_custom(material_var_flags_t flag, bool on)
	{
		...
		util::get_method< void(__thiscall*)(void*, material_var_flags_t, bool) >(this, 29)(this, flag, on);
	}

	__forceinline void ColorModulate(float r, float g, float b) {
		return util::get_method< void(__thiscall*)(void*, float, float, float) >(this, 28)(this, r, g, b);
	}
};
...
public:
	...
	__forceinline IMaterial* FindMaterial(const char* name, const char* group, bool complain = true, const char* complain_prefix = nullptr) {
		return  util::get_method< IMaterial * (__thiscall*)(void*, const char*, const char*, bool, const char*) >(this, FINDMATERIAL)(this, name, group, complain, complain_prefix);
	}
...
public:
	...
	float get_blend()
	{
		...
		return util::get_method< fn >(this, 5)(this);
	}

	void set_color_modulation(float* value)
	{
		using fn = void(__thiscall*)(void*, float*);
		return util::get_method< fn >(this, 6)(this, value);
	}
	...
	{
		using fn = void(__thiscall*)(void*, float*);
		return util::get_method< fn >(this, 7)(this, value);
	}
