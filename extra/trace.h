...
enum Masks_t {
	...
	CS_MASK_SHOT = MASK_SHOT_HULL | CONTENTS_HITBOX,
};
...
public:
	...
	__forceinline bool DidHitWorld();
	__forceinline bool DidHitNonWorldEntity();
};
...
public:
	...
	__forceinline void ClipRayToCollideable(const Ray& ray, unsigned int mask, void* collide, CGameTrace* trace) {
		return util::get_method< void(__thiscall*)(decltype(this), const Ray&, unsigned int, void*, CGameTrace*)>(this, CLIPCOLIDABLE)(this, ray, mask, collide, trace);
	}
};