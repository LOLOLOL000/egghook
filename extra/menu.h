...
public:
	...
	Checkbox      damage_accuracy_box;
	Slider		  damage_accuracy;
	Checkbox      lagfix;
	Checkbox	  correct;
	MultiDropdown baim1;
	MultiDropdown baim2;
...
public:
	void init() {
		...
		damage_accuracy_box.setup(XOR("damage accuracy"), XOR("damage_accuracy_box"));
		damage_accuracy_box.AddShowCallback(callbacks::IsConfigMM);
		damage_accuracy_box.AddShowCallback(callbacks::IsHitchanceOn);
		RegisterElement(&damage_accuracy_box, 1);

		damage_accuracy.setup("", XOR("damage_accuracy"), 1.f, 100.f, false, 0, 50.f, 1.f, XOR(L"%"));
		damage_accuracy.AddShowCallback(callbacks::IsConfigMM);
		damage_accuracy.AddShowCallback(callbacks::IsHitchanceOn);
		damage_accuracy.AddShowCallback(callbacks::IsAccuracyOn);
		RegisterElement(&damage_accuracy, 1);
		...
		delayshot.setup(XOR("delay shot"), XOR("delayshot"));
		RegisterElement(&delayshot, 1);
		...
		sparks.setup(XOR("draw sparks on shot"), XOR("sparks"));
		RegisterElement(&sparks, 1);
	}
};
...
public:
	...
	Checkbox avoid_lastmove;
	Checkbox flick_twice;
	Slider min_amount;
...
public:
	void init() {
		...
		avoid_lastmove.setup(XOR("avoid lastmove"), XOR("avoid_lastmove"));
		RegisterElement(&avoid_lastmove);

		min_amount.setup(XOR(""), XOR("min_amount"), 36.f, 60.f, false, 0, 36.f, 1.f, XOR(L"°"));
		RegisterElement(&min_amount);

		flick_twice.setup(XOR("flick on same place"), XOR("flick_twice"));
		RegisterElement(&flick_twice);
		...
		manul_antiaim.setup(XOR("enable manual anti-aim"), XOR("manul_antiaim"));
...
public:
	...
	Colorpicker   glow_projectile_color;
	Colorpicker   glow_friendly;
	Slider        glow_blend;
	Slider        glow_projectile_blend;
	...
	Slider chams_enemy_history_max_time;
...
public:
	void init() {
		...
		flags_enemy.setup(XOR("flags enemy"), XOR("flags_enemy"), { XOR("money"), XOR("armor"), XOR("scoped"), XOR("flashed"), XOR("reloading"), XOR("bomb"), XOR("hit") });
		...
		// col2.
		skeleton.setup(XOR("skeleton"), XOR("skeleton"), { XOR("enemy"), XOR("history") });
		...
		skeleton_alpha.setup(XOR("skeleton alpha"), XOR("skeleton_alpha"), 1.f, 100.f, true, 0, 100.f, 1.f, XOR(L"%"));
		RegisterElement(&skeleton_alpha, 1);

		glow.setup(XOR("glow"), XOR("glow"), { XOR("enemy"), XOR("projectiles") });
		RegisterElement(&glow, 1);

		glow_blend.setup(XOR("glow alpha"), XOR("glow_blend"), 10.f, 100.f, true, 0, 60.f, 1.f, XOR(L"%"));
		RegisterElement(&glow_blend, 1);

		glow_projectile_blend.setup(XOR("projectile glow alpha"), XOR("glow_projectile_blend"), 10.f, 100.f, true, 0, 60.f, 1.f, XOR(L"%"));
		RegisterElement(&glow_projectile_blend, 1);

		glow_enemy.setup(XOR("enemy color"), XOR("glow_enemy"), { 150, 200, 60 });
		RegisterElement(&glow_enemy, 1);

		glow_projectile_color.setup(XOR("projectile color"), XOR("glow_projectile_color"), { 150, 200, 60 });
		RegisterElement(&glow_projectile_color, 1);

		glow_type.setup(XOR("glow type"), XOR("glow_type"), { XOR("normal"), XOR("pulse"), XOR("outline"), XOR("outline pulse") });
		RegisterElement(&glow_type, 1);

		glow_bloom.setup(XOR("bloom glow"), XOR("glow_bloom"));
		RegisterElement(&glow_bloom, 1);

		chams_enemy_enable.setup(XOR("enable enemy chams"), XOR("chams_enemy_enable"));
		...
		chams_enemy_mat.setup(XOR("material"), XOR("chams_enemy_mat"), { XOR("default"),XOR("flat"), XOR("metallic"), XOR("pred glass"), XOR("crystal"), XOR("velvet"), XOR("gold") });
		...
		chams_enemy_history.setup(XOR("chams history"), XOR("chams_enemy_history"));
		RegisterElement(&chams_enemy_history, 1);

		chams_history_mat.setup(XOR("material"), XOR("chams_history_mat"), { XOR("default"),XOR("flat"), XOR("metallic"), XOR("pred glass"), XOR("crystal"), XOR("velvet"), XOR("gold") });
		...
		chams_enemy_history_max_time.setup(XOR("max time"), XOR("chams_enemy_history_max_time"), 1.f, 10.f, true, 0, 5.f, 1.f, XOR(L"s"));
		RegisterElement(&chams_enemy_history_max_time, 1);

		chams_local.setup(XOR("chams local"), XOR("chams_local"));
		RegisterElement(&chams_local);

		chams_local_mat.setup(XOR("material"), XOR("chams_local_mat"), { XOR("default"),XOR("flat"), XOR("metallic"), XOR("pred glass"), XOR("crystal"), XOR("velvet"), XOR("gold") });
...
public:
	...
	Checkbox      noflash;
	Checkbox      noscope;
	Colorpicker   molotov_color;
	Colorpicker   smoke_color;
	Checkbox      fov;
	Slider        fov_amt;
	Checkbox      fov_scoped;
...
public:
	void init() {
		...
		custom_molotov.setup(XOR("change smoke and molotov color"), XOR("custom_molotov"));
		RegisterElement(&custom_molotov);

		molotov_color.setup(XOR("molotov color"), XOR("molotov_color"), Color(255, 0, 0));
		molotov_color.AddShowCallback(callbacks::ShowMolotov);
		RegisterElement(&molotov_color);

		smoke_color.setup(XOR("smoke color"), XOR("smoke_color"), Color(255, 0, 0));
		smoke_color.AddShowCallback(callbacks::ShowMolotov);
		RegisterElement(&smoke_color);
		...
		chams_weapon.setup(XOR("chams weapon"), XOR("chams_weapon"));
		RegisterElement(&chams_weapon);

		weapon_chams_col.setup(XOR("color"), XOR("chams_weapon_col"), Color(87, 120, 221));
		RegisterElement(&weapon_chams_col);

		weapon_chams_mat.setup(XOR("material"), XOR("weapon_chams_mat"), { XOR("default"), XOR("flat"), XOR("metallic"), XOR("pred glass"), XOR("crystal"), XOR("velvet"), XOR("gold") });
		RegisterElement(&weapon_chams_mat);

		weapons_chams_blend.setup(XOR("alpha"), XOR("weapons_chams_blend"), 10.f, 100.f, true, 0, 100.f, 1.f, XOR(L"%"));
		RegisterElement(&weapons_chams_blend);
		...
		tracers_color.setup(XOR("trajectory color"), XOR("tracers_color"), Color(196, 127, 245));
...
public:
	void init() {
		...
		between_shots.setup(XOR("between shots"), XOR("between_shots"));
		RegisterElement(&between_shots, 1);

		force_accuracy.setup(XOR("force accuracy"), XOR("force_accuracy"));
		RegisterElement(&force_accuracy, 1);

		early.setup(XOR("predictive stop"), XOR("early"));
		RegisterElement(&early, 1);
...
public:
	...
	Checkbox custom_console;
	Colorpicker console_color;
	Slider console_color_alpha;

	// col2.
	Checkbox hide_angles;
	Checkbox autoaccept;
	Checkbox unlock;
	Checkbox hitmarker;
	...
	Checkbox killfeed;
	Checkbox ranks;
	Checkbox      server_impacts;
	Checkbox      client_impacts;
	Colorpicker server_impact_color;
	Colorpicker client_impact_color;
	Slider   client_alpha;
	Slider   impact_alpha;
	Checkbox custom_viewmodel;
	Slider viewmodel_x;
	Slider viewmodel_y;
	Slider viewmodel_z;
...
public:
	void init() {
		...
		server_impacts.setup(XOR("show server impacts"), XOR("server_impacts"));
		RegisterElement(&server_impacts);

		server_impact_color.setup(XOR("server color"), XOR("server_impact_color"), Color(0, 0, 255));
		RegisterElement(&server_impact_color);

		client_impacts.setup(XOR("show client impacts"), XOR("client_impacts"));
		RegisterElement(&client_impacts);

		client_impact_color.setup(XOR("client color"), XOR("client_impact_color"), Color(255, 0, 0));
		...
		// col2.
		hide_angles.setup(XOR("hide lby angles"), XOR("hide_angles"));
		RegisterElement(&hide_angles);
		...
		custom_console.setup(XOR("custom console color"), XOR("custom_console"));
		RegisterElement(&custom_console, 1);

		console_color.setup(XOR("console color"), XOR("console_color"), colors::white);
		RegisterElement(&console_color, 1);

		console_color_alpha.setup(XOR("alpha"), XOR("console_color_alpha"), 1, 255, true, 0, 255);
		RegisterElement(&console_color_alpha, 1);

		custom_viewmodel.setup(XOR("custom viewmodel"), XOR("custom_viewmodel"));
		RegisterElement(&custom_viewmodel, 1);

		viewmodel_x.setup(XOR("viewmodel x"), XOR("viewmodel_x"), -50, 50, true, 0, 0, 1.f, XOR(L"°"));
		RegisterElement(&viewmodel_x, 1);

		viewmodel_y.setup(XOR("viewmodel y"), XOR("viewmodel_y"), -50, 50, true, 0, 0, 1.f, XOR(L"°"));
		RegisterElement(&viewmodel_y, 1);

		viewmodel_z.setup(XOR("viewmodel z"), XOR("viewmodel_z"), -50, 50, true, 0, 0, 1.f, XOR(L"°"));
