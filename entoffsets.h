...
public:
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > fireCount;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_iPlayerState;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_fall_velocity;
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > velocity_modifier;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_Item;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > render_angles;
...
#define INIT_XOREDNETVAR_SPECIFIC( member_var, offset ) \
		...
		INIT_XOREDNETVAR(m_vecOrigin, HASH("DT_BaseEntity"), HASH("m_vecOrigin"));
		...
		INIT_XOREDNETVAR(fireCount, HASH("DT_Inferno"), HASH("m_fireCount"));
		...
		INIT_XOREDNETVAR(m_nSequence, HASH("DT_BaseViewModel"), HASH("m_nSequence"));
		...
		INIT_XOREDNETVAR(m_fFlags, HASH("DT_CSPlayer"), HASH("m_fFlags"));
		...
		INIT_XOREDNETVAR(m_angRotation, HASH("DT_BaseEntity"), HASH("m_angRotation"));
		INIT_XOREDNETVAR(m_angNetworkAngles, HASH("C_BaseEntity"), HASH("m_angNetworkAngles"));
		INIT_XOREDNETVAR(m_nTickBase, HASH("DT_BasePlayer"), HASH("m_nTickBase"));
		INIT_XOREDNETVAR(m_flNextAttack, HASH("DT_CSPlayer"), HASH("m_flNextAttack"));
		INIT_XOREDNETVAR(m_flDuckAmount, HASH("DT_CSPlayer"), HASH("m_flDuckAmount"));
		...
		INIT_XOREDNETVAR(m_iPlayerState, HASH("DT_CSPlayer"), HASH("m_iPlayerState"));
		...
		INIT_XOREDNETVAR(m_iObserverMode, HASH("DT_CSPlayer"), HASH("m_iObserverMode"));
		INIT_XOREDNETVAR(m_ArmorValue, HASH("DT_CSPlayer"), HASH("m_ArmorValue"));
		INIT_XOREDNETVAR(m_flMaxspeed, HASH("DT_CSPlayer"), HASH("m_flMaxspeed"));
		INIT_XOREDNETVAR(m_surfaceFriction, HASH("C_BasePlayer"), HASH("m_surfaceFriction"));
		INIT_XOREDNETVAR(m_angEyeAngles, HASH("DT_CSPlayer"), HASH("m_angEyeAngles[0]"));
		...
		INIT_XOREDNETVAR(m_fall_velocity, HASH("DT_CSPlayer"), HASH("m_flFallVelocity"));
		INIT_XOREDNETVAR(velocity_modifier, HASH("DT_CSPlayer"), HASH("m_flVelocityModifier"));
		...
		INIT_XOREDNETVAR(m_hActiveWeapon, HASH("DT_BasePlayer"), HASH("m_hActiveWeapon"));
		INIT_XOREDNETVAR(m_hGroundEntity, HASH("DT_BasePlayer"), HASH("m_hGroundEntity"));
		INIT_XOREDNETVAR(m_iItemDefinitionIndex, HASH("DT_BaseAttributableItem"), HASH("m_iItemDefinitionIndex"));
		INIT_XOREDNETVAR(m_Item, HASH("DT_BaseAttributableItem"), HASH("m_Item"));
		...
		INIT_XOREDNETVAR(m_iBurstShotsRemaining, HASH("DT_WeaponCSBaseGun"), HASH("m_iBurstShotsRemaining"));
		...
		INIT_XOREDNETVAR(m_zoomLevel, HASH("DT_WeaponCSBaseGun"), HASH("m_zoomLevel"));
		...
		INIT_XOREDNETVAR_SPECIFIC(render_angles, g_netvars.get(HASH("DT_BasePlayer"), HASH("deadflag")) + 4);
